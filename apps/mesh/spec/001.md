...
interface MeshTokenPayload {
  ...
  aud: string;           // Audience: Stable immutable identifier (e.g., "project:proj_abc123")
  jti: string;           // JWT ID: Unique identifier for revocation tracking
  
  // Mesh-specific claims
  projectId: string;     // Project ID (e.g., "proj_abc123")
  projectSlug: string;   // Project slug (e.g., "my-project") - for convenience, not security
...
interface MeshTokenPayload {
  ...
  aud: string;           // Audience: Stable immutable identifier (e.g., "project:proj_abc123") - REQUIRED
