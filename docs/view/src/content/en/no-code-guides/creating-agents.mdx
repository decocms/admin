...
In the Agents tab, click **Tools** → **Add Integration** to give your agent access to tools that come with pre-built integrtions (apps). Here, add new integrations or select from installed ones.
