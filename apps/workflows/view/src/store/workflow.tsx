...
type Workflow = NonNullable<Awaited<ReturnType<typeof client.DECO_RESOURCE_WORKFLOW_READ>>>;
type WorkflowStep = NonNullable<Awaited<ReturnType<typeof client.DECO_RESOURCE_WORKFLOW_READ>>>["data"]["steps"][number];
...
const WORKFLOW = {
    ...
    "steps": [
        ...
        },
        {
            ...
            "description": "Receives a UF acronym and matches it with the federal units list, returning the complete UF data (id, acronym, name)",
            "status": "completed",
            "toolCalls": [
                "None (Simple JavaScript)"
            ],
            "inputSchema": {
                "type": "object",
                "properties": {
                    "acronym": {
                        "type": "string",
                        "description": "The UF acronym to search for (e.g., 'SP', 'RJ', 'MG')"
                    },
                    "federalUnitsList": {
                        "type": "array",
        ...
        },
        {
            ...
            "description": "Searches for surveys (pesquisas) related to the selected UF, gets the first one found and fetches its complete details including questions and answers",
            "status": "completed",
            "toolCalls": [
                "SEARCH_PESQUISAS",
                "GET_PESQUISA_DETAILS"
            ],
            "inputSchema": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": "Fetches well-known IBGE indicators (population, area, density, education, economy) for the selected UF and returns a simplified array with name, value, and unit",
            "status": "completed",
            "toolCalls": [
                "IBGE_LIST_SURVEY_RESULTS"
            ],
            "inputSchema": {
                "type": "object",
                "properties": {
            ...
            "outputSchema": {
                ...
                "properties": {
                    "indicators": {
                        "type": "array",
                        "description": "Simplified list of indicators with name, value, and unit",
                        "items": {
                            "type": "object",
                            "properties": {
                                "name": {
        ...
        },
        {
            ...
            "description": "Query database to get the top 10 most voted parties in the specified UF (state) with total votes and number of candidates",
            "status": "completed",
            "toolCalls": [
                "DATABASES_RUN_SQL"
            ],
            ...
            "outputSchema": {
                ...
                "properties": {
                    "parties": {
                        "type": "array",
                        "description": "List of top 10 most voted parties with their statistics",
                        "items": {
                            "type": "object"
                        }
                    },
        ...
        },
        {
            ...
            "description": "Uses AI to generate a comprehensive political analysis in markdown format based on the federal unit data, 2024 election results, 2026 voting intentions, and IBGE indicators",
            "status": "completed",
            "toolCalls": [
                "AI_GENERATE_OBJECT"
            ],
        ...
        },
        {
            ...
            "description": "Takes the markdown output from Generate Political Analysis for UF and saves it as a prompt using PROMPTS_CREATE with the analysis name + state",
            "status": "completed",
            "toolCalls": [
                "PROMPTS_CREATE"
            ],
