...
export const logSafe = {
  info:(m,d)=>{try{console.log(m,d?maskValue(d):undefined);}catch{}},
  warn:(m,d)=>{try{console.warn(m,d?maskValue(d):undefined);}catch{}},
  error:(m,d)=>{try{console.error(m,d?maskValue(d):undefined);}catch{}},
};
