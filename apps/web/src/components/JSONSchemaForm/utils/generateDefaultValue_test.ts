import { assertEquals, assertNotEquals, assertExists } from "https://deno.land/std/testing/asserts.ts";
...
Deno.test("generateDefaultValue - with default values that not match schema", () => {
  ...
  assertEquals(generateDefaultValue(schemaWithDefault, wrongValue), "Default Value");
...
Deno.test("generateDefaultValue - object type", () => {
  ...
  const allRequiredResult = generateDefaultValue(allRequiredSchema) as Record<string, unknown>;
...
Deno.test("generateDefaultValue - object type with formData doesn't matching schema", () => {
  ...
  const result = generateDefaultValue(objectSchema, {name: "Name ok", age: "wrong"}) as Record<string, unknown>;
  ...
  const allRequiredResult = generateDefaultValue(allRequiredSchema, {name: "Name ok", age: "wrong"}) as Record<string, unknown>;
...
Deno.test("generateDefaultValue - array type", () => {
  ...
  const emptyArray = generateDefaultValue(arraySchema) as any[];
  ...
  const minItemsArray = generateDefaultValue(minItemsSchema) as any[];
...
Deno.test("generateDefaultValue - with form data", () => {
  ...
  const result = generateDefaultValue(schema, formData) as Record<string, unknown>;
...
Deno.test("generateDefaultValue - array with form data", () => {
  ...
  const result = generateDefaultValue(schema, formData) as any[];
