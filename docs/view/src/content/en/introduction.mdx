...
### Tools
Functions that agents can call to perform actions like API calls, database queries, or computations.
...
### Workflows
Deterministic sequences that orchestrate multiple tools for automation.
