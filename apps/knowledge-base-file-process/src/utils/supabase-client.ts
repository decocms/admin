import { getServerClient, type Database } from "@deco/sdk/storage";
...
export type AssetInsert = Database["public"]["Tables"]["deco_chat_assets"]["Insert"];
export type AssetUpdate = Database["public"]["Tables"]["deco_chat_assets"]["Update"]; 