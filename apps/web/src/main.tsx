...
const AgentList = lazy(() => wrapWithUILoadingFallback(import('./components/agents/list.tsx')));

const AgentDetail = lazy(() => wrapWithUILoadingFallback(import('./components/agent/edit.tsx')));

const PublicChats = lazy(() => wrapWithUILoadingFallback(import('./components/agent/chats.tsx')));

const AuditList = lazy(() => wrapWithUILoadingFallback(import('./components/audit/list.tsx')));

const AuditDetail = lazy(() => wrapWithUILoadingFallback(import('./components/audit/detail.tsx')));

const MagicLink = lazy(() =>
  wrapWithUILoadingFallback(import('./components/login/magic-link.tsx'))
);

const Settings = lazy(() => wrapWithUILoadingFallback(import('./components/settings/page.tsx')));

const Monitor = lazy(() => wrapWithUILoadingFallback(import('./components/monitor/page.tsx')));

const TriggerList = lazy(() => wrapWithUILoadingFallback(import('./components/triggers/list.tsx')));
...
const InvitesList = lazy(() => wrapWithUILoadingFallback(import('./components/invites/index.tsx')));

const SalesDeck = lazy(() => wrapWithUILoadingFallback(import('./components/sales-deck/deck.tsx')));
...
const AppAuth = lazy(() => wrapWithUILoadingFallback(import('./components/apps/auth.tsx')));

const ViewDetail = lazy(() => wrapWithUILoadingFallback(import('./components/views/detail.tsx')));

const ViewsList = lazy(() => wrapWithUILoadingFallback(import('./components/views/list.tsx')));
