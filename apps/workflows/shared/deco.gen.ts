...
export type Array_182 = String_1644[];
...
export type Array_184 = String_1653[];
export type String_1654 = string;
export type String_1655 = "none" | "open" | "autoPin";
export type Array_183 = Object_623[];
...
export interface Object_623 {
  ...
  icon: String_1649;
  url?: String_1650;
  mimeTypePattern?: String_1651;
  resourceName?: String_1652;
  tools?: Array_184;
  prompt?: String_1654;
  installBehavior?: String_1655;
}
 ...
 */
export type Array_188 = Object_628[];

export interface GENERATE_STEPInput {
  objective: String_1656;
  previousSteps?: Array_185;
  availableIntegrations?: Array_186;
  selectedTools?: Array_188;
}
export interface Object_624 {
  id?: String_1657;
  name: String_1658;
  outputSchema: Object_625;
}
...
export interface Object_627 {
  name: String_1661;
  description: String_1662;
}
export interface Object_628 {
  name: String_1663;
  integrationId: String_1664;
  integrationName: String_1665;
  description?: String_1666;
...
export interface GENERATE_STEPOutput {
  step: Object_631;
  reasoning?: String_1674;
}
export interface Object_631 {
  id: String_1667;
  name: String_1668;
  description: String_1669;
  execute: String_1670;
  inputSchema: Object_632;
  outputSchema: Object_633;
  input: Object_634;
  inputDescription?: Object_635;
  primaryIntegration?: String_1672;
  primaryTool?: String_1673;
  inputView?: Object_636;
  outputView?: Object_637;
}
...
export interface GENERATE_STEP_INPUT_VIEWInput {
  stepId: String_1675;
  fieldName: String_1676;
  fieldSchema: Object_638;
  previousStepId?: String_1677;
  previousStepOutput?: String_1678;
  viewName: String_1679;
  purpose: String_1680;
}
/**
 * Field JSON Schema
...
export interface GENERATE_STEP_INPUT_VIEWOutput {
  viewCode: String_1681;
  reasoning: String_1682;
}
...
export interface GENERATE_STEP_OUTPUT_VIEWInput {
  stepId: String_1683;
  stepName: String_1684;
  outputSchema: Object_639;
  outputSample: String_1685;
  viewName: String_1686;
  purpose: String_1687;
}
/**
 * Output JSON Schema
...
export interface GENERATE_STEP_OUTPUT_VIEWOutput {
  viewCode: String_1688;
  reasoning: String_1689;
}
 ...
 */
export type String_1691 = "input" | "output";
/**
...
export interface GENERATE_VIEWInput {
  purpose: String_1690;
  viewType: String_1691;
  dataSchema: Object_640;
  designPreference?: String_1692;
}
/**
...
export type Array_189 = (Object_641 | String_1694)[];
export type String_1695 = string;
export type String_1696 =
  | "primary"
  | "secondary"
  | "success"
  | "warning"
  | "error"
  | "info";
export type String_1697 = "sm" | "md" | "lg";
export type String_1698 = "vertical" | "horizontal" | "grid";
...
export interface GENERATE_VIEWOutput {
  view: Object_641;
  reasoning: String_1699;
  exampleData?: Object_644;
}
...
export type String_1700 = "input" | "output" | "both";

export interface GET_VIEW_EXAMPLESInput {
  viewType?: String_1700;
}
...
export type String_1703 = "input" | "output";
export type String_1704 =
  | "container"
  | "text"
  | "heading"
  | "card"
...
export type Array_191 = (Object_646 | String_1705)[];
export type String_1706 = string;
export type String_1707 =
  | "primary"
  | "secondary"
  | "success"
  | "warning"
...
export interface Object_645 {
  ...
  viewType: String_1703;
  view: Object_646;
  exampleData?: Object_649;
}
...
export interface IMPORT_TOOL_AS_STEPInput {
  ...
  integrationName: String_1712;
  toolDescription?: String_1713;
  inputSchema?: Object_650;
...
export interface Object_652 {
  id: String_1714;
  name: String_1715;
  description: String_1716;
  execute: String_1717;
  inputSchema: Object_653;
  outputSchema: Object_654;
  input: Object_655;
  inputDescription?: Object_656;
  primaryIntegration: String_1719;
  primaryTool: String_1720;
}
 ...
 * The type of step
 */
export type String_1728 = "code" | "tool_call";
/**
 * The unique ID of the step within the workflow
 */
 ...
 * Status of the step execution
 */
export type String_1733 = "pending" | "active" | "completed" | "error";
/**
 * ES module code that exports a default async function: (input: typeof inputSchema, ctx: { env: Record<string, any> }) => Promise<typeof outputSchema>. The input parameter contains the resolved input with all @ references replaced with actual values.
 */
 ...
 * List of integrations this step calls via ctx.env['{INTEGRATION_ID}'].{TOOL_NAME}(). These integrations must be installed and available for the step to execute successfully.
 */
export type Array_194 = Object_667[];
/**
 * Number of retry attempts for this step (default: 0)
 */
 ...
 * Backoff strategy for retry attempts (default: constant)
 */
export type String_1736 = "constant" | "linear" | "exponential";
/**
 * Maximum execution time in milliseconds (default: Infinity)
 */
 ...
 * Backoff strategy for retry attempts (default: constant)
 */
export type String_1739 = "constant" | "linear" | "exponential";
/**
 * Maximum execution time in milliseconds (default: Infinity)
 */
 ...
 * Array of workflow steps that execute sequentially. Each step can reference previous step outputs using @<step_name>.output.property syntax.
 */
export type Array_193 = Object_661[];
/**
 * The authorization token for the workflow
 */
...
export interface Object_658 {
  ...
  inputSchema: Object_659;
  outputSchema: Object_660;
  steps: Array_193;
  authorization?: Object_673;
}
/**
 * JSON Schema defining the workflow's input parameters and data structure
 */
...
export interface Object_661 {
   ...
   * The step definition based on the type
   */
  def?: Object_662 | Object_670;
  [k: string]: unknown;
}
export interface Object_662 {
  id?: String_1729;
  name?: String_1730;
  description?: String_1731;
  prompt?: String_1732;
...
export interface Object_670 {
  name?: String_1737;
  description?: String_1738;
  /**
   * Step configuration options. Extend this object with custom properties for business user configuration
   */
  options?: Object_671 | Null_175;
  tool_name?: String_1740;
  integration?: String_1741;
  [k: string]: unknown;
}
...
export type Array_195 = Object_680[];
export type String_1748 = string;

export interface RUN_WORKFLOW_STEPInput {
  step: Object_674;
  previousStepResults?: Object_678;
  globalInput?: Object_679;
  workflowSteps?: Array_195;
  authToken?: String_1748;
}
export interface Object_674 {
  id: String_1743;
  name: String_1744;
  execute: String_1745;
  inputSchema: Object_675;
  outputSchema: Object_676;
  input: Object_677;
}
...
export type Array_196 = Object_681[];
export type String_1751 = string;
export type String_1752 = string;
export type Array_197 = Object_683[];
...
export interface RUN_WORKFLOW_STEPOutput {
  ...
  error?: unknown;
  logs?: Array_196;
  resolvedInput?: Object_682;
  resolutionErrors?: Array_197;
  duration?: Number_136;
}
...
export type Array_198 = String_1753[];
export type String_1754 = string;
export type Array_199 = String_1754[];
...
export interface INTEGRATIONS_CALL_TOOLInput_2 {
  id?: String_1762;
  connection?: Object_687 | Object_688 | Object_690 | Object_691 | Object_692;
  params: Object_693;
}
...
export interface Object_692 {
  type: String_1776;
  name: String_1777;
  workspace?: String_1778;
}
export interface Object_693 {
  _meta?: Object_694;
  name: String_1780;
  arguments?: Object_695;
  [k: string]: unknown;
}
export interface Object_694 {
  progressToken?: String_1779 | Integer_95;
  [k: string]: unknown;
}
...
export interface INTEGRATIONS_LIST_TOOLSInput {
  connection: Object_696 | Object_697 | Object_699 | Object_700 | Object_701;
...
export type Array_203 = Object_708[];
export type Array_202 = Object_707[];
...
export type String_1838 = "grant" | "revoke";
...
export type String_1841 = "Bug" | "Idea";
...
export type String_1848 = "allow" | "deny";
export type String_1849 = string;
export type Array_204 = Object_712[];
export type String_1850 = string;
export type Array_205 = String_1850[];
export type String_1851 = string;
export type String_1852 = "grant" | "revoke";
/**
 ...
 */
export type Array_206 = Object_713[];
...
export type String_1856 = "allow" | "deny";
export type String_1857 = string;
export type Array_207 = Object_716[];
export type String_1858 = string;
export type Array_208 = String_1858[];
export type String_1859 = string;
export type String_1860 = "grant" | "revoke";
/**
 * Only send member actions for changes (diff between original and current state)
 *     Members who already have the role and remain selected: no action needed (maintains access)
 *     Members who don't have the role and remain unselected: no action needed (maintains no access)
 */
export type Array_209 = Object_717[];
...
export interface Object_716 {
  toolName: String_1855;
  effect: String_1856;
  policyId?: String_1857;
}
 ...
 */
export type String_1899 = "Google Fonts";
/**
 ...
 */
export type String_1901 = "Custom";
/**
...
export interface Object_719 {
  variables?: Object_720;
  picture?: String_1898;
  /**
   * Font configuration for the workspace
   */
  font?: Object_721 | Object_722;
}
/**
 * CSS custom properties for theme colors. Use OKLCH format (preferred) or hex colors.
 */
export interface Object_720 {
  "--background"?: String_1867;
  "--foreground"?: String_1868;
  "--card"?: String_1869;
  "--card-foreground"?: String_1870;
  "--popover"?: String_1871;
  "--popover-foreground"?: String_1872;
  "--primary"?: String_1873;
  "--primary-foreground"?: String_1874;
  "--primary-light"?: String_1875;
  "--primary-dark"?: String_1876;
  "--secondary"?: String_1877;
  "--secondary-foreground"?: String_1878;
  "--muted"?: String_1879;
  "--muted-foreground"?: String_1880;
  "--accent"?: String_1881;
  "--accent-foreground"?: String_1882;
  "--destructive"?: String_1883;
  "--destructive-foreground"?: String_1884;
  "--success"?: String_1885;
  "--success-foreground"?: String_1886;
  "--warning"?: String_1887;
  "--warning-foreground"?: String_1888;
  "--border"?: String_1889;
  "--input"?: String_1890;
  "--sidebar"?: String_1891;
  "--sidebar-foreground"?: String_1892;
  "--sidebar-accent"?: String_1893;
  "--sidebar-accent-foreground"?: String_1894;
  "--sidebar-border"?: String_1895;
  "--sidebar-ring"?: String_1896;
  "--splash"?: String_1897;
}
