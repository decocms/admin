...
const createMockContext = (authInstance: any = createMockAuth()): MeshContext => ({
  auth: {
...
describe('Organization Tools', () => {
  describe('ORGANIZATION_CREATE', () => {
    ...
    it('should require authentication', async () => {
      ...
      await expect(ORGANIZATION_CREATE.execute({
        name: 'Test',
        slug: 'test',
      }, ctx)).rejects.toThrow('Authentication required');
    });
