...
#### 5. MCP Bindings: Protocol-Level Interfaces
...
#### 7. Tool Registration and Pipeline
...
7. **Clear Naming**:
   - `core/` contains cross-cutting concerns (context, factory, access control, bindings)
   - `storage/ports.ts` defines contracts
   - `storage/adapters/` implements those contracts for specific databases
8. **Provider Abstraction**: MCP bindings enable polymorphic tool implementations and generic UIs
