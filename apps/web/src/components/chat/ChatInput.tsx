import { DEFAULT_REASONING_MODEL, MODELS, useThreadTools } from "@deco/sdk";
...
export function ChatInput() {
  ...
  const handleModelChange = undefined;
                  ...
                  {handleModelChange && (
                    <Select
                      ...
                      onValueChange={(value) => {
                        ...
                        handleModelChange(value).finally(() => {
