...
Workflows orchestrate multiple tools in sequence to automate complex processes. Unlike AI agents that decide which tools to call, workflows follow deterministic steps. Workflows in deco.chat use the Mastra framework under the hood, giving you a set of composable patterns for control flow.
