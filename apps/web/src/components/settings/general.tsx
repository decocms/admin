...
const generalSettingsSchema = z.object({
  ...
  teamSlug: z.string().regex(/^[a-zA-Z0-9_.-]+$/, {
    message: 'Team slug can only contain letters, numbers, dashes, underscores, and dots.',
  }),
...
export function GeneralSettings() {
  ...
  async function onSubmit(data: GeneralSettingsFormValues) {
    ...
    await updateTeam.mutateAsync({
      id: typeof currentTeamId === 'number' ? currentTeamId : Number(currentTeamId) || 0,
      data: {
        name: data.teamName,
        slug: data.teamSlug,
        theme: {
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          This prompt is added at the start of all agent messages for your team. Use
                          it to set tone, context, or rules.
                        </FormDescription>
                      </FormItem>
                    )}
                  />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          This prompt is added at the end of agent messages just for you. Use it to
                          personalize style or add your own context.
                        </FormDescription>
                      </FormItem>
                    )}
                  />
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Customize the theme of your team. Variables left blank will use the
                          default theme.
                        </FormDescription>
                        <FormControl>
                          <ThemeEditor
                  ...
                  <div className='p-6 bg-muted rounded-lg'>
                    <div className='flex flex-col gap-2'>
                      ...
                      <p className='text-xs text-muted-foreground'>
                        Permanently remove this team, all its connected integrations and uploaded
                        data
                      </p>
                      <DeleteTeamDialog
