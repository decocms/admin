    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: "tools", Component: ToolsResourceList, handle: { title: "Tools" } },
          { path: "agents", Component: AgentsListPage, handle: { title: "Agents" } },
          { path: "agents/threads", Component: AgentsThreadsPage, handle: { title: "Threads" } },
          { path: "agent/:id/:threadId", Component: AgentDetail, handle: { title: "Agent" } },
          { path: "apps", Component: InstalledAppsList, handle: { title: "Apps" } },
          { path: "apps/:appKey", Component: AppDetail, handle: { title: "App Details" } },
          { path: "apps/success", Component: AppInstallSuccess, handle: { title: "App Installed" } },
          {
            path: "triggers",
            Component: () => <Navigate to="../workflows/triggers" replace />,
          },
          { path: "trigger/:id", Component: TriggerDetails, handle: { title: "Trigger" } },
          {
            path: "database",
            Component: lazy(() => import("./components/database/studio.tsx")),
            handle: { title: "Database" },
          },
          { path: "views", Component: ViewsListPage, handle: { title: "Views" } },
          { path: "views/legacy", Component: ViewsLegacyPage, handle: { title: "Views (Legacy)" } },
          { path: "views/:integrationId/:viewName", Component: ViewDetail, handle: { title: "View" } },
          { path: "views/:id", Component: LegacyViewRedirect, handle: { title: "View" } },
          { path: "documents", Component: DocumentsListPage, handle: { title: "Documents" } },
          { path: "documents/prompts", Component: PromptsLegacyPage, handle: { title: "Prompts" } },
          { path: "documents/:id", Component: DocumentEdit, handle: { title: "Document" } },
          {
            path: "workflow-runs",
          ...
          { path: "workflows", Component: WorkflowsListPage, handle: { title: "Workflows" } },
          { path: "workflows/runs", Component: WorkflowsRunsPage, handle: { title: "Workflow Runs" } },
          { path: "workflows/runs-legacy", Component: WorkflowsRunsLegacyPage, handle: { title: "Workflow Runs (Legacy)" } },
          {
            path: "workflows/runs/:workflowName/instances/:instanceId",
            Component: WorkflowDetailPage,
            handle: { title: "Workflow Run" },
          },
          { path: "workflows/triggers", Component: WorkflowsTriggersPage, handle: { title: "Triggers" } },
          {
            path: "activity",
            Component: () => <Navigate to="../agents/threads" replace />,
            handle: { title: "Activity" },
          },
          { path: "audit/:id", Component: AuditDetail, handle: { title: "Audit" } },
