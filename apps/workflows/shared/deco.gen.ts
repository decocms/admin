 ...
 * The type of step
 */
export type String_1818 = "code" | "tool_call";
/**
 * The unique ID of the step within the workflow
 */
 ...
 * Status of the step execution
 */
export type String_1823 = "pending" | "active" | "completed" | "error";
/**
 * ES module code that exports a default async function: (input: typeof inputSchema, ctx: { env: Record<string, any> }) => Promise<typeof outputSchema>. The input parameter contains the resolved input with all @ references replaced with actual values.
 */
 ...
 * List of integrations this step calls via ctx.env['{INTEGRATION_ID}'].{TOOL_NAME}(). These integrations must be installed and available for the step to execute successfully.
 */
export type Array_204 = Object_632[];
/**
 * Number of retry attempts for this step (default: 0)
 */
 ...
 * Backoff strategy for retry attempts (default: constant)
 */
export type String_1826 = "constant" | "linear" | "exponential";
/**
 * Maximum execution time in milliseconds (default: Infinity)
 */
 ...
 * Backoff strategy for retry attempts (default: constant)
 */
export type String_1829 = "constant" | "linear" | "exponential";
/**
 * Maximum execution time in milliseconds (default: Infinity)
 */
...
export interface Object_623 {
  ...
  inputSchema: Object_624;
  outputSchema: Object_625;
  steps: Array_203;
  authorization?: Object_638;
}
/**
 * JSON Schema defining the workflow's input parameters and data structure
 */
...
export interface Object_627 {
  ...
  prompt?: String_1822;
  inputSchema?: Object_628;
  outputSchema?: Object_629;
  input?: Object_630;
  output?: Object_631;
  status?: String_1823;
  execute?: String_1824;
...
export interface Object_635 {
   ...
   * Step configuration options. Extend this object with custom properties for business user configuration
   */
  options?: Object_636 | Null_188;
  tool_name?: String_1830;
  integration?: String_1831;
  [k: string]: unknown;
}
...
export type Array_205 = Object_645[];
export type String_1838 = string;

export interface RUN_WORKFLOW_STEPInput {
  step: Object_639;
  previousStepResults?: Object_643;
  globalInput?: Object_644;
  workflowSteps?: Array_205;
  authToken?: String_1838;
}
export interface Object_639 {
  id: String_1833;
  name: String_1834;
  execute: String_1835;
  inputSchema: Object_640;
  outputSchema: Object_641;
  input: Object_642;
}
...
export type Array_206 = Object_646[];
export type String_1841 = string;
export type String_1842 = string;
export type Array_207 = Object_648[];
 ...
 * The type of step
 */
export type String_1846 = "code" | "tool_call";
/**
 * The unique ID of the step within the workflow
 */
 ...
 * Status of the step execution
 */
export type String_1851 = "pending" | "active" | "completed" | "error";
/**
 * ES module code that exports a default async function: (input: typeof inputSchema, ctx: { env: Record<string, any> }) => Promise<typeof outputSchema>. The input parameter contains the resolved input with all @ references replaced with actual values.
 */
 ...
 * List of integrations this step calls via ctx.env['{INTEGRATION_ID}'].{TOOL_NAME}(). These integrations must be installed and available for the step to execute successfully.
 */
export type Array_209 = Object_658[];
/**
 * Number of retry attempts for this step (default: 0)
 */
 ...
 * Backoff strategy for retry attempts (default: constant)
 */
export type String_1854 = "constant" | "linear" | "exponential";
/**
 * Maximum execution time in milliseconds (default: Infinity)
 */
 ...
 * Backoff strategy for retry attempts (default: constant)
 */
export type String_1857 = "constant" | "linear" | "exponential";
/**
 * Maximum execution time in milliseconds (default: Infinity)
 */
 ...
 * Array of workflow steps that execute sequentially. Each step can reference previous step outputs using @<step_name>.output.property syntax.
 */
export type Array_208 = Object_652[];
/**
 * The authorization token for the workflow
 */
...
export interface Object_661 {
  name?: String_1855;
  description?: String_1856;
  /**
   * Step configuration options. Extend this object with custom properties for business user configuration
   */
  options?: Object_662 | Null_189;
  tool_name?: String_1858;
  integration?: String_1859;
  [k: string]: unknown;
}
 ...
 * List of integrations this step calls via ctx.env['{INTEGRATION_ID}'].{TOOL_NAME}(). These integrations must be installed and available for the step to execute successfully.
 */
export type Array_211 = Object_674[];
/**
 * Number of retry attempts for this step (default: 0)
 */
 ...
 * Array of workflow steps that execute sequentially. Each step can reference previous step outputs using @<step_name>.output.property syntax.
 */
export type Array_210 = Object_668[];
/**
 * The authorization token for the workflow
 */
