      ...
      <div className="flex items-center">
        ...
        <div className="flex-none">
          {previous ? (
            ...
            >
              <Icon name="ChevronLeft" size={16} className="text-stone-500 opacity-50" />
              <span className="text-sm text-stone-500 leading-5">Previous</span>
            </a>
          ) : (
          ...
          {next ? (
            ...
            >
              ...
              <div className="flex items-center justify-center h-8 w-0">
                <div className="w-8 h-0 border-t border-stone-200 rotate-90"></div>
              </div>
              
              <div className="flex items-center gap-3 px-3 py-2 rounded-lg">
                <span className="text-sm text-stone-500 leading-5">Next</span>
                <Icon name="ChevronRight" size={16} className="text-stone-500 opacity-50" />
              </div>
            </a>
          ) : (
            <div className="flex items-center justify-end gap-2 px-3 py-4 rounded-lg">
              ...
              <div className="flex items-center gap-3 px-3 py-2 rounded-lg opacity-50">
                <span className="text-sm text-stone-500 leading-5">Next</span>
                <Icon name="ChevronRight" size={16} className="text-stone-500" />
              </div>
            </div>
          )}
        </div>
