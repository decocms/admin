    ...
    return (
      <ReactMarkdown
        ...
        components={{
          ...
          ul: (props) => <ul {...props} className='list-disc ml-6 my-4 space-y-2' />,
          ol: (props) => <ol {...props} className='list-decimal ml-6 my-4 space-y-2' />,
          ...
          td: (props) => <td {...props} className='px-4 py-2 border-b border-border' />,
        }}
      >
        {content}
      </ReactMarkdown>
...
export const MemoizedMarkdown = ({
  ...
  return blocks.map((block, index) => {
    ...
    return <MemoizedMarkdownBlock content={block.raw} key={`${id}-block_${index}`} />;
  });
};
