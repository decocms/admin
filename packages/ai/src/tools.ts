...
const RenderInputSchema = z.object({
  ...
  mediaType: z.enum(["image", "video", "audio"]).optional().describe("The media type of the content. This is only required if type is 'url' and the content is the URL of a file."),
});
